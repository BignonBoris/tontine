...
import 'package:agent/core/services/agent_notification_display_service.dart';
...
class PushNotificationService {
  ...
  Future<void> start({String appName = 'agent'}) async {
    ...
    await AgentNotificationDisplayService.init();
    _registerListeners();
  ...
  void _registerListeners() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      try {
        await AgentNotificationDisplayService.showInstantNotification(
          title,
          body,
          payload: payload,
        );
