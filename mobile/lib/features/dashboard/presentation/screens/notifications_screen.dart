...
class NotificationsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DashboardBloc, DashboardState>(
      builder: (context, state) {
        final hasUnread = state is DashboardLoaded &&
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              ...
              Expanded(
                child: _buildNotificationsBody(context, state),
              ),
            ],
          ),
        );
  ...
  Widget _buildNotificationsBody(BuildContext context, DashboardState state) {
